      ...
      <aside className="w-1/2 h-full relative z-[2] grid ">
        <div className="w-[35%] h-fit text-black p-5">
          ...
          <p className="text-sm mb-1 font-light p-2">
            Confirm your attendace by filling in the information below to
            confirm your attendance and get added to the guest list
          </p>
          <form
          ...
          >
            <input
              type="text"
              placeholder="Event"
              className="w-full p-2 border border-gray-300 rounded bg-orange-50 box-decoration-slice text-black"
            />
            <input
              type="text"
              placeholder="Name"
            ...
            ></textarea>
            <label htmlFor="quantity" className="font">
              number of guests
            </label>
            <input
              type="number"
