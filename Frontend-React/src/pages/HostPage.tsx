...
const HostPage = () => {
  return (
    <div className="flex flex-col justify-center items-center bg-white pt-20 pb-24">
      <section className="border-2 border-dashed border-neutral-400 rounded-xl text-center cursor-pointer flex flex-col items-center justify-center h-56 w-80 sm:w-96">
        <div className="mb-3">
